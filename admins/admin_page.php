            ...
            <div class="row">
                <div class="col-md-4 order-md-2 mb-4">                
                    <ul class="list-group mb-3">
                        ...
                        <div>
                            <h6 class="my-0 text-secondary">ADMIN: <span style="color:black;">Etunimi Sukunimi</span></h6>
                        </div>                                                         
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0"><a href="" class="text-danger">Ilmoita aikataulun muutoksesta</a></h6>
