    ...
    .then(function(response) {
        ...
        data.forEach(item => {               
            ...
            content = `<ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">                   
                        <div>
                            <a href="" class="btn btn-sm btn-block" style="background:#6ED3CF; color:white;">MUUTA</a>                                                     
                        </div>
                        <div>
                            <input type="number" class="form-control" style="width:58px; height: 31px; margin-right:auto; margin-left:auto;" value="${item.quantity}"/> 
                            <div style="height:7px;"></div>
                            <span class="text-muted">${item.sum_product} €</span>                           
                        </div>
                        <div>
                            <a href="" class="btn btn-sm btn-block" style="background:#6ED3CF; color:white;">POISTA</a>                            
                        </div>                  
                        </li>
                        </ul>
