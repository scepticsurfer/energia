...
<div class="container-fluid custom-margin-container">
    ...
    <div class="custom-adds">
        ...
        <p>
            ...
            Cras ultricies arcu metus, volutpat pharetra lorem sollicitudin ullamcorper. 
            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Quisque vitae pharetra dolor. 
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-7" style="margin-bottom:10px; text-transform:uppercase;"><h2>Pilates</h2></div>
            ...
            <div class="custom-container"><img class="custom-product" src="pics/pilates.jpeg" alt=""> 
                    <div class="custom-top-right"><h3>60€/kk</h3></div> 
        ...
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-7" style="margin-bottom:10px; text-transform:uppercase;"><h2>Jooga</h2></div>
                <div class="col-xl-5" style="margin-bottom:10px; text-align:right;"><a href="cart/cart.php" class="custom-cart">OSTAA</a></div>
            </div>  
            <div class="custom-container"><img class="custom-product" src="pics/jooga.jpeg" alt=""> 
                    <div class="custom-top-right"><h3>30€/kk</h3></div>
                    <div class="custom-overlay">
                        <div class="custom-image-text">
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-7" style="margin-bottom:10px; text-transform:uppercase;"><h2>Sauna</h2></div>
                <div class="col-xl-5" style="margin-bottom:10px; text-align:right;"><a href="cart/cart.php" class="custom-cart">OSTAA</a></div>
            </div>  
        ...
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-7" style="margin-bottom:10px; text-transform:uppercase;"><h2>Hieronta</h2></div>
                <div class="col-xl-5" style="margin-bottom:10px; text-align:right;"><a href="cart/cart.php" class="custom-cart">OSTAA</a></div>
            </div>  
            <div class="custom-container"><img class="custom-product" src="pics/hieronta.jpeg" alt=""> 
                    <div class="custom-top-right"><h3>25€/t</h3></div>
                    <div class="custom-overlay">
                        <div class="custom-image-text">
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-7" style="margin-bottom:10px; text-transform:uppercase;"><h2>Zumba</h2></div>
                <div class="col-xl-5" style="margin-bottom:10px; text-align:right;"><a href="cart/cart.php" class="custom-cart">OSTAA</a></div>
            </div>  
        ...
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-7" style="margin-bottom:10px; text-transform:uppercase;"><h2>Kausikortti</h2></div>
                <div class="col-xl-5" style="margin-bottom:10px; text-align:right;"><a href="cart/cart.php" class="custom-cart">OSTAA</a></div>
            </div>  
            <div class="custom-container"><img class="custom-product" src="pics/kausikortti.jpeg" alt="">
                    <div class="custom-top-right"><h3>90€/kk</h3></div> 
                    <div class="custom-overlay">
                        <div class="custom-image-text">
