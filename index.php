...
<div class="container-fluid custom-margin-container">
    ...
    <div class="custom-adds">
        <div class="row">
        <div class="col-xl-8">
        <h2 class="custom-blue-title"><b>KUNTOKLUBIN ENERGIA</b> <span>KUUKAUDEN HUIPPUTARJOUKSIA!</span></h2>
        <p></p>
        <p>
    ...
    <div class="row">
        <div class="col-xl-6">
            ...
            <div class="custom-container"><img class="custom-product" src="pics/ohjaaja.jpg" alt="">
                    <div class="custom-top-right"><h3>30€/t</h3></div> 
                    <div class="custom-overlay">
                        <div class="custom-image-text">
                        Kun haluat suunnitelmallista ja yksilöllistä ohjausta, ammattitaitoinen ja 
                        motivoiva personal trainer auttaa sinut saavuttaa tavoitteesi.                                                             
                        </div>
                    </div>
            </div>                    
        </div>
...
<script type="text/javascript" src="cart/put_product_cart.js"></script>
